...
class TestFCReLU(Module):
    def __init__(self, keep_prob=0, dtype=np.float32, seed=None):
        self.net = sequential(
            ########## TODO: ##########
            flatten(name="flato"),
            fc(input_dim=15,output_dim=5,name="fullo"),
            leaky_relu(name="l_relu")
            ########### END ###########
        )
...
class SmallFullyConnectedNetwork(Module):
    def __init__(self, keep_prob=0, dtype=np.float32, seed=None):
        self.net = sequential(
            ########## TODO: ##########
            flatten(name="flato"),
            fc(input_dim=4,output_dim=30,init_scale=0.002,name="fullo_1"),
            leaky_relu(name="l_relu_1"),
            fc(input_dim=30,output_dim=7,init_scale=0.002,name="fullo_2"),
            leaky_relu(name="l_relu_2")
            ########### END ###########
        )
...
class TinyNet(Module):
    def __init__(self, keep_prob=0, dtype=np.float32, seed=None):
        """ Flatten->Fully Connected->LReLU->Fully Connected /+ LReLU """
        self.net = sequential(
            ########## TODO: ##########
            flatten(name="flato"),
            fc(input_dim=3072,output_dim=512,init_scale=0.02,name="fullo_1"),
            leaky_relu(name="l_relu_1"),
            fc(input_dim=512,output_dim=10,init_scale=0.02,name="fullo_2"),
            #leaky_relu(name="l_relu_2"),
